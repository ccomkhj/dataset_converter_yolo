...
def draw_box_on_image(image_source, classes, colors, label_folder, raw_images_folder, save_images_folder ):
...
if __name__ == "__main__":
    ...
    image_names = list(Path(raw_images_folder).glob("*"))

    image_total = 0
    logger.info(f'{len(list(image_names))} images will be processed.')
